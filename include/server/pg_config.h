...
#define CONFIGURE_ARGS " '--prefix=/home/darragh/postgresql-17.4' '--enable-debug' 'CFLAGS=-O0'"
...
#define PG_VERSION_STR "PostgreSQL 17.4 on aarch64-unknown-linux-gnu, compiled by gcc (Ubuntu 11.4.0-1ubuntu1~22.04.2) 11.4.0, 64-bit"
